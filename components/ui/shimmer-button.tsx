        ...
        return (
            <button
                ...
                className={cn(
                    ...
                    "bg-white/90 border-2 border-emerald-500/30 text-slate-900",
                    // Dark mode: dark background with purple border and light text
                    "dark:bg-purple-900/90 dark:border-purple-400/30 dark:text-white",
                    // Interaction states
                ...
                >
                    ...
                    <div className="absolute inset-0 h-[100cqh] animate-shimmer-slide [aspect-ratio:1] [border-radius:0] [mask:none]">
                        ...
                        <div className="animate-spin-around absolute -inset-full w-auto rotate-0 
                            bg-[conic-gradient(from_calc(270deg-(var(--spread)*0.5)),transparent_0,#10b981_var(--spread),transparent_var(--spread))]
                            dark:bg-[conic-gradient(from_calc(270deg-(var(--spread)*0.5)),transparent_0,#a78bfa_var(--spread),transparent_var(--spread))]
                            [translate:0_0]"
                        />
                    </div>
                </div>
