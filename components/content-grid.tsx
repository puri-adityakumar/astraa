  ...
  return (
    ...
    >
      {items.map((contentItem, index) => {
        ...
        const isAvailable = contentItem.status === "available";
        const cardContent = (
          <>
            ...
            <div className="mt-auto pt-8">
              ...
              <h3 className="text-base font-semibold tracking-[-0.02em]">{contentItem.name}</h3>
        ...
        return (
          ...
          >
            {isAvailable ? (
              ...
              <article className="relative flex min-h-[210px] flex-col bg-background p-5 sm:p-6">
                {cardContent}
              </article>
            )}
          </motion.div>
