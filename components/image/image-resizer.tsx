    ...
    <div className="mx-auto max-w-5xl space-y-8 pb-8">
      <div className="space-y-3 border-b pb-8 text-left">
        ...
        <p className="text-muted-foreground text-lg">
          Choose an image, set its pixel dimensions, and export it as JPEG, PNG, or WebP.
        </p>
        ...
        <div className="grid gap-8 lg:grid-cols-[1fr,320px]">
          <div className="space-y-4">
            ...
            <label
              ...
              className="relative block cursor-pointer rounded-xl border-2 border-dashed bg-muted/30 p-8 text-center transition-colors hover:bg-muted/50"
            >
              <input
                id="image-upload"
                type="file"
              ...
              />
              <span className="sr-only">Choose an image to resize</span>
              <div className="pointer-events-none space-y-2">
                <span className="text-sm font-medium">Choose an image or drag it here</span>
