    ...
    <div className="space-y-8">
      ...
      <div className="space-y-4">
        <div className="flex items-end gap-2">
          ...
          {/* Height */}
          <div className="flex-1 space-y-2">
            <Label className="font-normal text-muted-foreground">Height</Label>
            <Input
              type="number"
          ...
          <div className="flex shrink-0 items-center">
            <div className="flex h-10 items-center justify-center rounded-md border bg-muted/50 px-3 text-sm text-muted-foreground">
              px
            </div>
          </div>
        </div>
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          ...
          <Slider
            ...
            onValueChange={([value]) =>
              value !== undefined && onOptionsChange({ quality: value })
            }
            min={1}
            max={100}
            step={1}
      ...
      <div className="space-y-6 pt-2">
        <div className="flex items-center justify-between text-sm">
          ...
          <Button
            ...
            onClick={onReset}
            disabled={disabled}
            className="h-auto p-0 px-2 text-muted-foreground hover:bg-transparent hover:text-foreground"
          >
        ...
        <div className="flex items-center gap-2 text-sm font-medium">
          ...
          <span
            className={cn(
              ...
              estimatedByteSize &&
                originalByteSize &&
                estimatedByteSize > originalByteSize
