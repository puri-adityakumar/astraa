      ...
      <div className="space-y-4">
        <div className="flex items-end gap-2">
          ...
          <div className="flex-1 space-y-2">
            <Label htmlFor="image-width" className="font-normal text-muted-foreground">
              Width
            </Label>
            <Input
              id="image-width"
          ...
          {/* Height */}
          <div className="flex-1 space-y-2">
            <Label htmlFor="image-height" className="font-normal text-muted-foreground">
              Height
            </Label>
            <Input
              id="image-height"
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-3">
          <div className="flex justify-between items-center">
            <Label id="image-quality-label" className="font-normal text-muted-foreground">
              JPEG/WebP quality
            </Label>
