...
import { PatternHighlightInput, type PatternHighlightInputHandle } from "./pattern-highlight-input";
...
export const PatternRow = forwardRef<PatternHighlightInputHandle, PatternRowProps>(
  function PatternRow({ error, onShare, exportSlot }, ref) {
    ...
    const handleChange = useCallback((next: string) => setPattern(next), [setPattern]);
    ...
    return (
      <div className="space-y-3">
        <div className="flex items-center gap-2">
          <span aria-hidden="true" className="font-mono text-lg text-muted-foreground select-none">
            /
          </span>
