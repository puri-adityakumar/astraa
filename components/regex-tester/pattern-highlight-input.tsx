...
const TOKEN_CLASS: Record<PatternToken["type"], string> = {
  ...
  escape: "text-foreground/70",
  charClassOpen: "text-foreground font-medium",
  charClassClose: "text-foreground font-medium",
  range: "text-foreground/80",
  groupOpen: "text-muted-foreground font-medium",
  namedGroupOpen: "text-muted-foreground font-medium",
  nonCaptureGroupOpen: "text-muted-foreground font-medium",
  groupClose: "text-muted-foreground font-medium",
  lookaheadPositive: "text-foreground/60",
  lookaheadNegative: "text-foreground/60",
  lookbehindPositive: "text-foreground/60",
  lookbehindNegative: "text-foreground/60",
  alternation: "text-foreground font-bold",
  quantifier: "text-muted-foreground",
  anchorStart: "text-foreground/80",
  anchorEnd: "text-foreground/80",
  wordBoundary: "text-foreground/80",
  nonWordBoundary: "text-foreground/80",
  backreference: "text-foreground/70",
};
