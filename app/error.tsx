      ...
      >
        <Card className="glass p-6 md:p-10 text-center space-y-8">
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-2">
              ...
              <p className="text-muted-foreground text-sm md:text-base max-w-md mx-auto">
                Don't worry, it's not your fault. An unexpected error occurred. Try refreshing the
                page or go back to continue.
              </p>
            </div>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            <Button size="lg" onClick={reset} className="min-w-[140px] flex items-center gap-2">
