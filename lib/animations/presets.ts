...
export const cardHoverAnimations = {
  lift: {
    whileHover: { y: -8 },
    transition: { duration: ANIMATION_CONFIG.duration.fast, ease: ANIMATION_CONFIG.ease.default }
  },
  scale: {
...
export const scrollAnimations = {
  fadeInUp: {
    ...
    transition: { duration: ANIMATION_CONFIG.duration.slow, ease: ANIMATION_CONFIG.ease.smooth }
  },
  fadeInScale: {
